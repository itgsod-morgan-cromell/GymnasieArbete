...
GameClock manages time in the following ways:
    ...
    1.  Run main engine at a constant speed, independent of variable frame rate.
...
Python-based multi-media and main development libraries.
"""
...
class GameClock(object):
    ...
    Parameters:
        ...
        max_frame_skip -> Positive integer. Max main ticks allowed before
    ...
    Methods:
        tick() -> Game loop timer. Call once per main loop.
    ...
    def tick(self):
        """Game loop timer. Call once per main loop to calculate runtime values.
    ...
    def interpolate(self):
        ...
        previous gametick and the next one. This allows the main main loop to
